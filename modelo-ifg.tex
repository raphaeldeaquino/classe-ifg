...
% -------- Primeiro(a) coorientador(a)
% Se não houver primeiro(a) coorientador(a) comente os dois comandos abaixo
\pcoorientador{Dr. Fulano de Tal}
% Unidade do(a) primeiro(a) coorientador(a) dentro da instituição. No caso de haver
% mais de um departamento inclua o departamento, a sigla da 
% instituição e o câmpus, como no modelo. Em câmpus com um único 
% departamento inclua somente a sigla da instituição e o câmpus.
\unidadepco{Departamento IV - IFG / Câmpus Goiânia} 
% Use o comando a seguir se for primeira coorientadora e não coorientador. 
% Neste caso comente o primeiro comandos acima inserindo % no início 
%\pcoorientadora{Dra. Nome da primeira coorientadora}
% -------- Segundo(a) coorientador(a)
% Se não houver segundo(a) coorientador(a) comente os dois comandos abaixo
\scoorientador{Dr. Fulano de Tal}
% Unidade do(a) segundo(a) coorientador(a) dentro da instituição. No caso de haver
% mais de um departamento inclua o departamento, a sigla da 
% instituição e o câmpus, como no modelo. Em câmpus com um único 
% departamento inclua somente a sigla da instituição e o câmpus.
\unidadesco{Departamento IV - IFG / Câmpus Goiânia} 
% Use o comando a seguir se for segunda coorientadora e não coorientador. 
% Neste caso comente o primeiro comandos acima inserindo % no início 
%\scoorientadora{Dra. Nome da segunda coorientadora}

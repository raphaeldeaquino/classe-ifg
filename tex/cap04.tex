...
Os elementos essenciais são: autor (ou organização), título da informação ou serviço ou produto, versão ou edição (se houver), local, data e descrição física do meio eletrônico.
...
O campo \verb|author| só deve ser usado quando a autoria do documento se referir a uma pessoa. Quando a autoria for uma organização deve ser trocado para \verb|organization|. Use o campo \verb|org-short| para indicar como citar a organização usando um nome mais curto como, por exemplo, sua sigla.\\

EXEMPLO 3

EMPRESA DE PESQUISA ENERGÉTICA. \textbf{EPE e ANEEL fortalecem parceria para intercâmbio técnico e compartilhamento de conhecimento}. 2024. Disponível em: https://www.epe.gov.br/pt/imprensa/noticias/epe-e-aneel-fortalecem-parceria-para-intercambio-tecnico-e-compartilhamento-de-conhecimento. Acesso em: 25 nov. 2024.
...
@misc{epe24,
 ...
 epe-e-aneel-fortalecem-parceria-para-intercambio-
 tecnico-e-compartilhamento-de-conhecimento},
 urlaccessdate={25 nov. 2024},
 year = {2024}
}
\end{verbatim}
